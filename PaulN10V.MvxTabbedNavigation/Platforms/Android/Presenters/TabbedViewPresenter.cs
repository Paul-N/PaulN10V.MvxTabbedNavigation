...
using PaulN10V.MvxTabbedNavigation.Platforms.Android.Core;
...
using PaulN10V.MvxTabbedNavigation.Presenters.Hints;
...
namespace PaulN10V.MvxTabbedNavigation.Platforms.Android.Presenters;
